...
I have trained over 15,000 persons across Nigeria in various ICT field. 

- **Data Analyst** using Python, R, Power BI, Tableau, Advance Excel, and Ms SQL Server.
- **Project Management Professional (PM)** with good knowledge of Microsoft Project.
- **Database Administrator** with very good knowledge of Database Management System (Oracle 11g).
- **FileMaker Database Application Developer** and database integration expert.
- **Customized software developer** for small and medium-scale businesses aimed at problem-solving.
- **Accountant** with very good knowledge of accounting packages like Sage 50 (Peachtree), Tally ERP, and QuickBooks.
...
### Accountant
- **Dec 2020 - Present**
- **Rocad Construction Company | Kano, Nigeria**
- **Key Responsibilities:**
  - Preparing the company accounts to ensure compliance with required standard.
  - Filing monthly VAT and annual returns with Tax Authority (FIRS in).
  - Monitoring and ensure that Projects expenses are within project budgets.
  - Monitoring supplier's records to ensure they are paid as at when due.

### Kano Centre Manager
- **Dec 2009 - Dec 2020**
- **Hiit Training Institute | Kano, Nigeria**
- **Key Responsibilities:**
  - Centre administrative head/Facility manager.
  - Data Analysis instructor.
  - Accounting applications instructor (QuickBooks, Tally ERP, Sage 50).
  - Project Management Professional Instructor.

### NYSC
- **Dec 2005 - Dec 2006**
- **Adesemi Nig Ltd | Aba, Nigeria**
- **Key Responsibilities:**
  - Keeping details of client payment of monthly subscription.
  - Preparation of salary voucher and payment of staff salary.
  - Running shift at the Network Operation Centre (Network Trouble Shooting).

### Computer Instructor
- **Dec 2002 - Dec 2005**
- **Rehoboth Computers | Abraka, Nigeria**
- **Key Responsibilities:**
  - Ms Office and CorelDraw Instructor.
  - System Engineer.

### Accountant
- **Dec 1998 - Dec 2002**
- **Dumjos Chemist Nig. Ltd. | Jos, Nigeria**
- **Key Responsibilities:**
  - Preparation of salary voucher and payment of staff salary.
  - Proper keeping of all accounting books/records (bank and cash).
  - Scrutinize all sales and purchases invoices to ascertain correctness.

### Auditor
- **Dec 1995 - Dec 1998**
- **Micheal Nwoke & Sons | Jos, Nigeria (CHARTERED ACCOUNTANT) JOS**
- **Key Responsibilities:**
  - Carrying out clients bi-monthly stock taking.
  - Full audit of clients financial records.

---

## Profile

- **Data Manipulation and Modelling with Microsoft Excel**
...
- **Data Manipulation and Modelling with Microsoft Excel** (2020)
  - **Scenario Academy | Lagos, Nigeria**
- **Data Storytelling with Power BI** (2020)
  - **Scenario Academy | Nigeria**
- **Data Science and Machine Learning with Python** (2020)
  - **Scenario Academy | Nigeria**
- **Project Management Professional** (2012)
  - **HiiT Institute | Lagos, Nigeria**
- **Bachelor of Science, Accounting and Finance** (2006)
  - **Delta State University | Abraka, Nigeria**
- **National Diploma** (1993)
  - **Federal Polytechnic Kaduna | Kaduna, Nigeria**
...
- **Python, R, SQL**
- **BI Reporting, Data Modeling / Statistical Modeling**
- **Data Visualization, Data Visualization Tools (Tableau, Qlikview, Hue)**
- **Microsoft SQL, Oracle DB**
- **English: Fluent**
...
- Excellent knowledge of accounting packages including QuickBooks, Sage 50, and Tally ERP.
